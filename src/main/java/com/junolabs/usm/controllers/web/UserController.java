...
public class UserController extends CRUDController {
	...
	@Override
	protected ResponseProccess proccessEditValue(HttpServletRequest request, HttpServletResponse response) throws IOException {
		PrintWriter printWriter = response.getWriter();
		printWriter.println("EDIT VALUE PROCCESS");
