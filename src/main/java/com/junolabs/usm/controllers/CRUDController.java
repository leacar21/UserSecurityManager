...
public abstract class CRUDController {
	...
	// Estas operaciones cargan parametros genericos que sirven para todos los
	...
	protected abstract ResponseProccess proccessEditValue(HttpServletRequest request, HttpServletResponse response) throws IOException;
